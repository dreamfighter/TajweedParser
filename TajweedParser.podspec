#
#  Be sure to run `pod spec lint TajweedParser.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "dreamfighter" => "dreamfighter.id@gmail.com" }
  # Or just: spec.author    = "dreamfighter"
  # spec.authors            = { "dreamfighter" => "dreamfighter.id@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/dreamfighter"
  ...
  spec.source_files  = "TajweedParser/Library/**/*"
